...
public class Gestures {
    ...
    private static WindowsDriver<WindowsElement> driver = QXClient.getWindowsDriver();
    private Actions actions = new Actions(QXClient.getWindowsDriver());

    public Gestures(WindowsDriver<WindowsElement> driver) {
        this.driver = driver;
    ...
    //
    public void clickOnWindowsbutton(WindowsElement element) {

        actions.click(element).build().perform();

    }

    public void clickAndSendtextToWindowsTextField(WindowsElement element, String text) {

        actions.click(element).sendKeys(text).build().perform();

    }
    public void MaximizeTheScreen(WindowsDriver<WindowsElement> driver)
    {
        driver.manage().window().maximize();
    }
    public void MinimizeTheScreen(WindowsDriver<WindowsElement> driver)
    {
       // driver.manage().window().
    }

    public void ClickOnEnter(WindowsElement element) {
        element.sendKeys(Keys.ENTER);
    }

    public void ClickonEnterUsingActionsClass(WindowsElement element) {
...
//
    ...
    public void tocuh(WindowsDriver driver, int x, int y)  {
        /*
         * Dimension dims = driver.manage().window().getSize(); int edgeBorder = 10;
         * PointOption pointOptionStart, pointOptionEnd; // init start point = center of
         * screen pointOptionStart = PointOption.point(dims.width / 2, dims.height / 2);
...
//        int scrollStart = (int) dimension.getHeight();
//
//        System.out.println("scroll starts at ========> " + scrollStart);
//        int scrollEnd = (int) (dimension.getHeight() * 0.3838);
//        System.out.println("scroll end at ======> " + scrollEnd);
//        //int scrollEnd = 450;
//        int widthHalf = (int) (dimension.getWidth() * 0.5);
//
//        try {
