...
public class GenerateDynamicXpath_Page {
    ...
    public GenerateDynamicXpath_Page(WindowsDriver<WindowsElement> driver) throws InterruptedException {
        this.driver = driver;
    ...
    public void EanInitilizeElementsUsingDynamicXpath(String ean, String xaph) throws InterruptedException {
    ...
    public void GenerateDynamicXpathPage(String xaph) {
...
//=======
   ...
   public void initializeElementsUsingDynamicXpath(String xaph) {

        boolean elementFound = false;

        for (String xpath : DYNAMIC_XPATH_LIST) {
        ...
        if (!elementFound) {
            for (String xpath : DYNAMIC_XPATH_NUMBER_LIST) {
                if (findElementByXPath(xpath)) {
                    break;
                }
            }
    ...
    private boolean findElementByXPath(String xpath) {
        try {
            EanEle = driver.findElementByAccessibilityId(":" + xpath + ":");
            System.out.println(EanEle.getText() + "================>text");
            return true;
        } catch (Exception e) {
            System.out.println(e.getMessage() + " - Element not found with xpath: " + xpath);
            return false;
        }
    }
